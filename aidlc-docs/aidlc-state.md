...
| INFRA-001 | 인프라 마이그레이션 | ap-northeast-2 → us-east-1 전체 인프라 재구성 (Terraform) | 2026-05-20 | ✅ 완료 |
| DATA-001 | 데이터 마이그레이션 | 기존 RDS → 신규 RDS 전체 테이블 데이터 이관 (12테이블) | 2026-05-20 | ✅ 완료 |
| MERGE-001 | 브랜치 머지 | feat/unit1-frontend → main 머지 + 11개 파일 충돌 해결 | 2026-05-20 | ✅ 완료 |
